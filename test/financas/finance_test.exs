defmodule Financas.FinanceTest do
  use Financas.DataCase

  alias Financas.Finance

  describe "receitas" do
    alias Financas.Finance.Receita

    import Financas.FinanceFixtures
    ...
    test "create_receita/1 with valid data creates a receita" do
      valid_attrs = %{data: ~D[2024-11-19], descricao: "some descricao", valor: "120.5"}
    ...
    test "update_receita/2 with valid data updates the receita" do
      receita = receita_fixture()
      update_attrs = %{data: ~D[2024-11-20], descricao: "some updated descricao", valor: "456.7"}

      assert {:ok, %Receita{} = receita} = Finance.update_receita(receita, update_attrs)
      assert receita.data == ~D[2024-11-20]
  ...
  describe "despesas" do
    ...
    test "update_despesa/2 with valid data updates the despesa" do
      ...
      assert despesa.data == ~D[2024-11-20]
